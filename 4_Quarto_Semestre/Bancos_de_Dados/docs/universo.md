...
* **Mídia de um jogo:** O sistema armazena apenas links (URLs) das capturas de tela (screenshots) oficiais dos jogos. Foi desconsiderado o armazenamento direto de arquivos pesados no banco, vídeos ou imagens postadas pela comunidade.
...
* Deve ser possível registrar e manter os dados cadastrais dos usuários, incluindo nome de usuário, nome, e-mail, senha (armazenada de forma segura utilizando hash criptográfico), data de nascimento e saldo da carteira virtual.
...
* Deve ser possível associar URLs de capturas de tela (screenshots) aos jogos para apresentação na loja.
